                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            //Login Box and text
                            Consumer<UserInfo>(builder: (context, userInfo,
                                other) {
                              return Positioned(
                                left: 200,
                                top: 340,
                                child: TextButton(
                                  onPressed: () {
                                    print("[Login button] - button click");

                                    // get password value from controller

                                    userInfo.updatePassValue(_controller.text);
                                    print('[Login button] - Saving user password info: ${_controller.text}');

                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            withScreenDecoration(
                                              const Home(),
                                            ),
                                      ),
                                    );
